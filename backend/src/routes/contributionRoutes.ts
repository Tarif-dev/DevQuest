...
import { scoreContribution } from "../services/vincent";
    ...
    try {
      ...
      res.json({
        ...
        data: {
          ...
          message:
            contributionStatus === "APPROVED"
              ? `Contribution approved with score ${score}! Payout of ${payoutAmount} PYUSD is being processed.`
...
// POST /api/contributions/:id/analyze - Trigger Vincent AI analysis
router.post(
  "/:id/analyze",
  authenticate,
  async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      // Analyze contribution using Vincent AI
